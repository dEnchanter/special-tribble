      ...
      <Card className="w-full max-w-[400px] p-8 bg-gray-900/60 backdrop-blur-sm border-gray-800">
        <div className="flex flex-col items-center space-y-6">
          ...
          <Link href="/" className="flex flex-col items-center z-40 font-semibold text-2xl">
            <span className="text-zinc-200">Welcome back to</span>
            <div>
  ...
  return (
    <div className="flex justify-end">
      <Link 
        ...
        className="font-medium text-xs bg-gradient-to-r from-brand-700 to-brand-800 text-transparent bg-clip-text px-2"
      >
        Forgot password
      </Link>
    </div>
